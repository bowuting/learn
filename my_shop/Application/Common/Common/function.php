...
/*发送短信*/
 function sendSms($phone,$num){
    ...
    $post_data = "account=yunduan363&password=zzys66669999&mobile={$phone}&content=".rawurlencode("您的验证码是：{$num}。如需帮助请联系客服。");
    return $gets = Post($post_data, $target);
}
