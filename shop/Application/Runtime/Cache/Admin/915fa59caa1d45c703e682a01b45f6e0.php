...
<html lang="zh-cn">
  ...
  <body>
      ...
      <form class="" action="/github/www/shop/index.php/Admin/Index/updateGoodsCatAction" method="post">
          <table class="table table-bordered">
              <tr>
                  ...
                  <td>
                    <input type="hidden" id="id"name="id" value="<?php echo ($res['goodscat_id']); ?>">
                      <input type="text" id="name" name="name" value="<?php echo ($res['goodscat_name']); ?>">
                  </td>
              </tr>
              <tr>
                  <td>
              ...
              <tr>
                  ...
                  <td>
                      <input id="sort" type="text" name="sort" value="<?php echo ($res["goodscat_sort"]); ?>">
                  </td>
              </tr>
              <tr>
                  <td colspan="2" class="text-center">
                    ...
                    <button type="button" name="button" class="btn btn-primary">ajax</button>
                  </td>
              </tr>
          </table>
